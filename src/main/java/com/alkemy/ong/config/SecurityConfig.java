...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, ApiConstants.MEMBERS_URI).hasAnyRole("USER")
                .antMatchers(HttpMethod.GET, ApiConstants.MEMBERS_URI).hasAnyRole("USER")
                .antMatchers(HttpMethod.PUT, ApiConstants.MEMBERS_URI + "/{id}").hasAnyRole("USER")
                .antMatchers(HttpMethod.DELETE, ApiConstants.MEMBERS_URI + "/{id}").hasAnyRole("ADMIN")
